...
const useMouseStore = zustand.create(log((set) => ({
    curSettings: {},
    layers: [],
    logging: false,
...
function UpdateFollower({ mouseOptions, style, className, onMouseEnter, onMouseLeave, onClick, children, }) {
    ...
    return (jsxRuntime.jsx("div", { style: style, className: className, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, onClick: onClick, children: children }));
}
...
function FollowerDiv({ pos, options }) {
    ...
    return (jsxRuntime.jsx(framerMotion.motion.div, { initial: {
            x: pos.x,
            y: pos.y,
            scale: 1,
            ...
            borderRadius: '9999px',
            overflow: 'hidden',
        }, transition: { type: 'tween', duration: options.followSpeed ? 0.3 / options.followSpeed : 0.3, ease: 'circOut' }, id: "mouse-follower", children: jsxRuntime.jsx("div", { style: {
                ...
                backgroundColor: 'transparent',
                    ...
                    alignItems: 'center',
                    overflow: 'hidden',
                }, children: [options.text && !options.backgroundElement ? (jsxRuntime.jsx(framerMotion.motion.p, { initial: { opacity: 0.7 }, animate: { opacity: 1 }, transition: { type: 'tween', duration: options.followSpeed ? 0.3 / options.followSpeed : 0.3, ease: 'circOut' }, style: {
                            width: '85%',
                            textAlign: 'center',
                        ...
                        }, children: options.text })) : null, jsxRuntime.jsx(framerMotion.AnimatePresence, { mode: "wait", children: options.backgroundElement ? (jsxRuntime.jsx(framerMotion.motion.div, { style: {
                                width: '100%',
                                height: '100%',
                                borderRadius: '9999px',
                                display: 'flex',
...
function FollowerInitialiserComponent() {
    ...
    return (jsxRuntime.jsx(ManagePosition, { options: !isHovering ? Object.assign(Object.assign({}, options), { scale: 0, customLocation: null, customPosition: null }) : options }));
}
function ManagePosition({ options }) {
    ...
    return (jsxRuntime.jsx(framerMotion.AnimatePresence, { mode: "wait", children: options.visible !== false ? jsxRuntime.jsx(FollowerDiv, { options: options, pos: pos }) : null }));
}

function MouseFollower() {
    return jsxRuntime.jsx(FollowerInitialiserComponent, {});
}
...
exports.useControlOptions = useControlOptions;
